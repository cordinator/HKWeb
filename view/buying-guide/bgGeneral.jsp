...
<s:layout-definition>
  ...
  <div class="">
    ...
    <div id="bgHeaderCont">
      <s:layout-component name="bgHeader">
        <s:layout-render name="/buying-guide/bgHeader.jsp"/>
      </s:layout-component>
    </div>
    ...
    <div id="footer">
      <s:layout-component name="bgFooter">
        <s:layout-render name="/buying-guide/bgFooter.jsp"/>
      </s:layout-component>
    </div>
