...
<script type="text/javascript" src="<hk:vhostJs/>/assets/js/devJs/handlebarsCommon.js?v=1.4"></script>
...
<script type="text/javascript" src="<hk:vhostJs/>/assets/js/devJs/common.js?v=1.47"></script>
<%--js finish--%>
