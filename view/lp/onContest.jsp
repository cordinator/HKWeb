...
<s:layout-render name="/templates/landingPageContest.jsp" pageTitle="ON Contest">
  ...
  <s:layout-component name="content">
    ...
    <div style="text-align: center;"><img src="<hk:vhostImage/>/lp/images/on-banner.jpg"/></div>
