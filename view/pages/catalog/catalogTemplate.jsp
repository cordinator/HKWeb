...
<s:layout-render name="/layouts/catalog/_filtersLayout.jsp" actionBean="${catalogAction}"></s:layout-render>
<s:layout-render name="/layouts/catalog/_productsLayout.jsp" actionBean="${catalogAction}"></s:layout-render>
