...
HKCatalog.prototype.prepareBrandsText = function(){
  var str = '',
      _self = this,
      selectedElements = $(_self.elms.navKey);
  $.each(selectedElements,function(){
    str += ($(this).val()).replace(_self.statics.BRAND_PREFIX,"") + _self.statics.BRAND_SEP;
  });
