...
HK.catalog.eventMapper[HK.catalog.events.filterModified] = ["prepareCatPrefixText", "prepareBrandsText", "prepareFilterGroupText", "preparePerPageText", "prepareSortByText"];
HK.catalog.eventMapper[HK.catalog.events.changePerPage] = ["prepareCatPrefixText", "prepareBrandsText", "prepareFilterGroupText", "preparePerPageText", "prepareSortByText", "preparePriceText"];
HK.catalog.eventMapper[HK.catalog.events.sortVariants] = ["prepareCatPrefixText", "prepareBrandsText", "prepareFilterGroupText", "preparePerPageText", "prepareSortByText","preparePriceText"];
HK.catalog.eventMapper[HK.catalog.events.priceRangeChanged] = ["prepareCatPrefixText", "prepareBrandsText", "prepareFilterGroupText", "preparePerPageText", "prepareSortByText", "preparePriceText"];
HK.catalog.eventMapper[HK.catalog.events.loadMore] = ["prepareCatPrefixText", "prepareBrandsText", "prepareFilterGroupText", "preparePerPageText", "prepareSortByText", "preparePriceText", "prepareLoadMoreText"];
HK.catalog.eventMapper[HK.catalog.events.resetAll] = ["prepareCatPrefixText"];
...
$('body').on(HK.catalog.events.filterModified,function(event){
  var reqURL = HK.catalog.createURL(event);
...
$('body').on(HK.catalog.events.priceRangeChanged,function(event, data){
  ...
  reqURL = HK.catalog.createURL(event);
...
$('body').on(HK.catalog.events.loadMore,function(event){
  var loadMoreBar = $(HK.catalog.elms.loadMore),
      url = '';
    url = HK.catalog.createLoadMoreURL(event);
...
$(window).scroll( function () {
  var seoContentHeight = $('.seoContainer').height();
  if ( $(document).height() - ( seoContentHeight + $(window).scrollTop() ) < 1200 ) {
