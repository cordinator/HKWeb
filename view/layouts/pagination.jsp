...
<s:layout-definition>
  ...
  %>
  <div class="pagination clr-cont cont-rht">
      <ul>
          <%-- Previous link if applicable --%>

        <s:layout-render name="/layouts/_pageNoLink.jsp" paginatedBean="${paginatedBean}"
                         pageNo="<%=basePaginatedAction.getPageNo()-1%>"   pageText="Previous" isDisable="<%=(basePaginatedAction.getPageNo() <= 1)%>"/>
        ...
        %>
        <s:layout-render name="/layouts/_pageNoLink.jsp" paginatedBean="${paginatedBean}"
                         pageNo="<%=basePaginatedAction.getPageNo()+1%>" pageText="Next"/>
        <%
          }
        %>
      </ul>
