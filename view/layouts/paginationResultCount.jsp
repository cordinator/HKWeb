...
<s:layout-definition>
  ...
  %>
  <span class="">Showing <span data-role="startResult"><%=startResult%></span> - <%=endResult%> of <%=basePaginatedAction.getResultCount()%> ${noOfReviews ne null ? 'reviews' : 'results'} </span>
  <%
  } else {
  %>
