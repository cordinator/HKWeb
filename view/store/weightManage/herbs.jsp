...
<s:layout-render name="/store/msGeneral.jsp" title="HERBS">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">HERBS</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="46429,12864,12839,37979,12965,37940,42192,13044,37930,13605,42581,13600,13603,45189" showAddToCart="true"/>
   </div>
  </s:layout-component>
