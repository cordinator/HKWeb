...
<s:layout-render name="/store/msGeneral.jsp" title="FAT BURNER">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">FAT BURNER</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="48812,42652,13164,42130,47052,46997,13133,13460" showAddToCart="true"/>
   </div>
  </s:layout-component>
