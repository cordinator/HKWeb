...
<s:layout-render name="/store/msGeneral.jsp" title="WEIGHT MANAGEMENT DEVICES">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">WEIGHT MANAGEMENT DEVICES</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="45000,7021,16686,7023,44999,38343,7018,38344,7019,16691,10430,16689,38346,37769,16690,25812,36531,48166,41006,3780,38338,40998,41005,10684,23954" showAddToCart="true"/>
   </div>
  </s:layout-component>
