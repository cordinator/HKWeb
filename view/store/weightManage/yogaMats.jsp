...
<s:layout-render name="/store/msGeneral.jsp" title="Yoga Mats">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Yoga Mats</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="20452,19737,19682,23185" showAddToCart="true"/>
   </div>
  </s:layout-component>
