...
<s:layout-render name="/store/msGeneral.jsp" title="SPECIALTY PRODUCTS">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">SPECIALTY PRODUCTS</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="42385,42386,12880,44822,42159,12825,38015,12766,45174,15161,42348,15160,13942,42572,45164,15868,42645" showAddToCart="true"/>
   </div>
  </s:layout-component>
