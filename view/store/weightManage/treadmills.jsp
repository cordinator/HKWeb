...
<s:layout-render name="/store/msGeneral.jsp" title="Treadmills">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Treadmills</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="39705,44683,44686,39706,40181,40190,39704,46572,47417,40184,47396,39706,40185,47386,40187,45748" showAddToCart="true"/>
   </div>
  </s:layout-component>
