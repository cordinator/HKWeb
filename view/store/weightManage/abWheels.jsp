...
<s:layout-render name="/store/msGeneral.jsp" title="Ab Wheels/Machines">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Ab Wheels/Machines</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="36538,47525,47802,39095,39134,22601" showAddToCart="true"/>
   </div>
  </s:layout-component>
