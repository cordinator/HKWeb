...
<s:layout-render name="/store/msGeneral.jsp" title="Steppers">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Steppers</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="22619,19963,20458,39137,23963,21542,21491" showAddToCart="true"/>
   </div>
  </s:layout-component>
