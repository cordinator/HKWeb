...
<s:layout-render name="/store/msGeneral.jsp" title="BODY SHAPING">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">BODY SHAPING</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="572,5708,25465,33665,25648,37788,46870,46862,18109" showAddToCart="true"/>
   </div>
  </s:layout-component>
