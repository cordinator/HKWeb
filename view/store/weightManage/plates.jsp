...
<s:layout-render name="/store/msGeneral.jsp" title="Vibration Plates">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Vibration Plates</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="21169,47462,45308" showAddToCart="true"/>
   </div>
  </s:layout-component>
