...
<s:layout-render name="/store/msGeneral.jsp" title="Twisters">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Twisters</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="23168,21543,19962,24363,19821" showAddToCart="true"/>
   </div>
  </s:layout-component>
