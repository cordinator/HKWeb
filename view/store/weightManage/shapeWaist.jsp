...
<s:layout-render name="/store/msGeneral.jsp" title="SHAPE YOUR WAIST">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">SHAPE YOUR WAIST</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="23168,21543,19962,24363,19821,21169,47462,45308,22619,19963,20458,39137,23963,21542,21491" showAddToCart="true"/>
   </div>
  </s:layout-component>
