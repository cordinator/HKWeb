...
<s:layout-render name="/store/msGeneral.jsp" title="HEALTH DRINKS">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">HEALTH DRINKS</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="15247,15126,15443,15442,15444,15626,15637,13294,13296,13295" showAddToCart="true"/>
   </div>
  </s:layout-component>
