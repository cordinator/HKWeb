...
<s:layout-render name="/store/msGeneral.jsp" title="Exercise Bikes">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Exercise Bikes</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="21487,46852,21480,44713,40200,46557,44714,46509,47458,46561,39924,40206" showAddToCart="true"/>
   </div>
  </s:layout-component>
