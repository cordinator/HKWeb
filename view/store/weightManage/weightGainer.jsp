...
<s:layout-render name="/store/msGeneral.jsp" title="WEIGHT GAINER">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">WEIGHT GAINER</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="48806,15515,13559,42120,15516,49759,15518,49753" showAddToCart="true"/>
   </div>
  </s:layout-component>
