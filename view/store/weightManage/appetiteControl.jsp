...
<s:layout-render name="/store/msGeneral.jsp" title="APPETITE CONTROL">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">APPETITE CONTROL</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="44493,42604,42245" showAddToCart="true"/>
   </div>
  </s:layout-component>
