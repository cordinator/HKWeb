...
<s:layout-render name="/store/msGeneral.jsp" title="Oils & Lotions">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Oils &amp; Lotions</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="572,5708,25465,33665,25648" showAddToCart="true"/>
   </div>
  </s:layout-component>
