...
<s:layout-render name="/store/msGeneral.jsp" title="Home Gyms">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Home Gyms</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="44681,24352,46531,40202,39923,40201,46528,46531,46514,46513,46512,39741" showAddToCart="true"/>
   </div>
  </s:layout-component>
