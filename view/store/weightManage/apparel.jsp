...
<s:layout-render name="/store/msGeneral.jsp" title="Apparel">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
    ...
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="37788,46870,46862,18109" showAddToCart="true"/>
   </div>
  </s:layout-component>
