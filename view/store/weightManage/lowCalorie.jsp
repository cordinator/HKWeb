...
<s:layout-render name="/store/msGeneral.jsp" title="Low Calorie Food">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Low Calorie Food</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="15446,42385,13286,12790,38006,15604,45108,15667" showAddToCart="true"/>
   </div>
  </s:layout-component>
