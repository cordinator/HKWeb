...
<s:layout-render name="/store/msGeneral.jsp" title="Weighing Scales">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Weighing Scales</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="45000,7021,16686,7023,44999,38343,7018,38344,7019" showAddToCart="true"/>
   </div>
  </s:layout-component>
