...
<s:layout-render name="/store/msGeneral.jsp" title="Gym Balls">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Gym Balls</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="20453,23178,19811,39171,39657,23971,45828" showAddToCart="true"/>
   </div>
  </s:layout-component>
