...
<s:layout-render name="/store/msGeneral.jsp" title="Body Fat Monitors">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">Body Fat Monitors</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="16691,10430,16689,38346,37769,16690,25812,36531" showAddToCart="true"/>
   </div>
  </s:layout-component>
