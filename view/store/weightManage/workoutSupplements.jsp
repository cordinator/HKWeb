...
<s:layout-render name="/store/msGeneral.jsp" title="WORKOUT SUPPLEMENTS">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">WORKOUT SUPPLEMENTS</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="48812,42652,13164,42130,47052,46997,13133,13460,48806,15515,13559,42120,15516,49759,15518,49753,44493,42604,42245" showAddToCart="true"/>
   </div>
  </s:layout-component>
