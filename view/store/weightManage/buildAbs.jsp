...
<s:layout-render name="/store/msGeneral.jsp" title="BUILD ABS">
  <%
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
     <h1 class="headingH1">BUILD ABS</h1>
    <s:layout-render name="/store/weightManage/weightManageCatalogLayout.jsp" vid="36538,47525,47802,39095,39134,22601,20453,23178,19811,39171,39657,23971,45828,20452,19737,19682,23185" showAddToCart="true"/>
   </div>
  </s:layout-component>
