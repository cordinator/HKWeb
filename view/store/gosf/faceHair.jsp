...
<s:layout-render name="/store/msGeneral.jsp">
  ...
  <s:layout-component name="msContent">
   <div class="wrapper">
     <span class="gosfH1">Face &amp; Hair Care</span>
    <s:layout-render name="/store/gosf/gosfCatalogLayout.jsp" vid="10816,11679,17636,11680,42887,334,48201,37824,40610,5046,41641,5642,24539,44633,8667,10815,10932,11681,44709,42111,46322,10840,44416,37826,11683,42888,19397,46254,47187,45965,4304,4484,47772,33481,33678,37405,47194,47848,46241,42868,42901,24527,47851,40698,25575" showAddToCart="true"/>
   </div>
  </s:layout-component>
