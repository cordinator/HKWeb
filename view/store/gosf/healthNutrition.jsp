...
<s:layout-render name="/store/msGeneral.jsp">
  ...
  <s:layout-component name="msHeading">
        ...
        <div class="gosfBanner">
          <div class="wrapper">
            <img src="<hk:vhostImage/>/assets/images/gosf/health-nutrition.png">
          </div>
        </div>
        <!--- banner close --->
  ...
  <s:layout-component name="msContent">
   ...
   <div class="wrapper">
    <s:layout-render name="/store/gosf/gosfCatalogLayout.jsp" vid="48532,12933,15185,12787,12879,15134,13643,48534,12796,42626,45276,42555,13968,45228,12837,14226,45218,42629,45103,45102,13958,14405,15779,12823,12883,15336,12899,14228,14557,14556,2507,48533,12938,13952,48535,45166,12941,12932,15980,14229,48536,12930,12926,12824,14440,12789,12783,42187,13502,15866,45315,12799,48192,12812,12917,2885,37920,13924,13914,12819,12942,13963,42628,12801,12800,12881,13920,14077,15979,13925,37925,15699,12803,37936,37932,13923,12841,13187,45286,15161,15160,12880,14484,14548,12815,12839,46429,12825,45174,12880,12827,13916,13935,13955,45266,13994,12821,13996,12847,13938,12937,15188,15178,15284,14552,15283,15189,15164,13989,13931,12886,12845,13917,14231,37931,37922,12916,13949,37934,12907,12909,45268,13991,15174,5275,12811,12870,13921,13915,12771,14232,13678,45162,48164,12830,37919,15172,12877,12810,14441,37924,44970,13988,14500,14431,15193,45165,12844,13686,13283,42640,37933,12794,12773,12866,12785,12956,45157,12872,12927,13956,12797,12908,12868,12772,37913,37914,37917,14545,37910,14546,14558,12822,15348,13676,37918,37916,15330,15345,13191,15351,15697,15352,15346,15787,15354,15865,15343,15784,15785,13042" showAddToCart="true"/>
   </div>
  </s:layout-component>
