...
<s:layout-definition>
    ...
    <link rel="stylesheet" type="text/css" href="<hk:vhostCss/>/assets/css/gosf/gosf.css"
          media="screen">
  ...
  <div id="header">
    <div class="wrapper">
      ...
      <div class="logo">
       <a href="${pageContext.request.contextPath}/preGosf/index.jsp"> <img class="gosf-logo" src="<hk:vhostImage/>/assets/images/gosf/gosf-logo.png">     </a>
      ...
      <!-- account and cart--->
        ...
        <div class="row cont-rht text-left cart-mt" style="margin-top: -12px;">
