		...
		extends J2EESecurityManager
{
	 ...
	 * {@link #hasRoleName(net.sourceforge.stripes.action.ActionBean, java.lang.reflect.Method, String)} to determine if the user has a role without
	 ...
	 * this method instead of {@link #hasRole(net.sourceforge.stripes.action.ActionBean, java.lang.reflect.Method, String)} to keep using the EL expression logic but
